...
export default function PrivacyPolicy() {
  return (
    ...
    <div className="top">
      ...
      <h2 className="section">5. Your Rights and Choices</h2>
      ...
      <h2 className="section">6. Children’s Privacy</h2>
      ...
      <h2 className="section">7. Third-Party Links</h2>
      ...
      <h2 className="section">8. Changes to This Privacy Policy</h2>
