...
import slctemple from '../../Assets/Img/slctemple.png'
    ...
    <div className="wrapper">
      ...
      <div>
        <p className='paragraph'>
          Is the Mormon church a church or a kingdom – the literal Kingdom of God on earth as Joseph Smith claimed?
      ...
      <div className="paragraph">
        <p>
          Christian churches do not claim to be the Kingdom of God. Rather, they
          anticipate Christ’s return to earth and the establishment of a
          Millennial Kingdom. However, Joseph Smith revealed in 1831, “The keys
          of the Kingdom of God are committed unto man on the earth, and from
      ...
      <div className="paragraph">
        <p>
          ...
          fulfilling Daniel’s prophecy was front and center of Joseph Smith’s
      ...
      <h2 className="headlinePadding" >The Literal Kingdom of God in the Last Days</h2>
     
      <div className="paragraph">
        <p>
          Joseph and the early Mormons believed that they had established the
          Kingdom of God in their day. Yet today the church teaches that the
          Kingdom of God is a concept that will come to pass in the future. “The
          kingdom of God means the government of God ... But that principle will
          not be fulfilled … until, as we are told in the scriptures, the
          kingdoms of this world are become the kingdoms of our Lord and his
      ...
      <div className="paragraph">
        <p>
          However, historian Klaus Jansen noted, “If [Joseph] Smith waited until
          1844 before he formally organized the government of the kingdom, the
      ...
      <div className="paragraph">
        <p>By the end of his life, Joseph believed that he had established
      ...
      <div className="paragraph">
        <p>
          ...
          as the current “King, Priest, and Ruler over Israel on the Earth” when
          he became the Mormon prophet? Joseph Smith’s successors Brigham Young
          and John Taylor were both anointed Kings when they became the prophet
          in secret ceremonies for which we have documentary evidence.
        </p>
      </div>

      <div className="paragraph">
        <p>
          Perhaps the latest group of Mormon prophets forgo being covertly
          crowned in our modern day – a bad look. But do they secretly consider
          themselves as the King of the Kingdom of God as “King, Priest, and
          Ruler over Israel on the Earth” and God’s representative to preside
          ...
          and as they say, it is good to be the king.
        </p>
      </div>

      <div className="paragraph">
        <p>
          A secretive body known as the Council of Fifty witnessed Joseph
          Smith’s ordination as “King, Priest, and Ruler over Israel on the
          Earth” – and the placing of a crown upon his head. Nauvoo Stake
          President William Marks stated, “I was also witness of the
          ...
          <Tooltip anchorSelect="#clickable19" className="footnote-size" clickable>Diary of George A. Smith, May 9,1844, located in the Library of the 
            ...
            Conflict in Hancock County, Illinois, 1839-1846, Ph.D. dissertation, BYU, 1967, pp. 63-65.</Tooltip>
        </p>
      </div>

      <div className="paragraph">
        <p>
          The second anointing is a secretive temple ordinance never discussed
          publicly by church leaders. Russell Nelson, and all upper echelon
          ...
          Mormon prophet as “King, Priest, and Ruler over Israel on the Earth”
          is another secretive ordinance never discussed publicly for obvious
          reasons.
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          The Mormon church teaches that there is a clear line of succession
          from Joseph Smith to each subsequent Mormon prophet – a continuing
          chain of priesthood authority and keys. Each successor holds the same
      ...
      <div className="paragraph">
        <p>
          Therefore, if these priesthood keys are possessed by Russell Nelson,
          and God is the same yesterday, today, and forever, have all Mormon
          prophets been crowned as “King, Priest, and Ruler over Israel on the
          Earth” in secretive ceremonies as was Joseph Smith, Brigham Young, and
          John Taylor, for which we have documentary evidence? Were the other
          bestowals of crowns kept secret for all other succeeding Mormon
          prophets? As has been revealed, the Mormon church tends to hide things
          from its members.
        </p>
      </div>

      <div className="paragraph">
        <p>So, let’s look to see whether the Mormon church
          believes that it is a church or God’s literal kingdom on the earth.
        </p>
      </div>

      

      <h2 className="headlinePadding" >The Prophecy that Started it All</h2>
      <div className="paragraph">
        <p>
          In the Old Testament, Daniel, a noble Jewish youth, is taken captive
          into Babylon around 605 BCE. Although faithful to the God of Israel,
      ...
      <div className="paragraph">
        <p>
          According to Daniel’s interpretation, the dream foretells future world
          history and the eventual establishment of the Kingdom of the God of
          Israel that will rule over all political kingdoms – an interesting
          story coming from a people just brought into bondage by the
          Babylonians. Daniel saw an image of a man with “head of fine gold, and
          breast and arms of silver, and belly and thighs of brass, and legs of
          iron, and feet of iron and clay.” Then, a small stone cut out of a
          mountain without hands begins to roll. Gaining momentum, it strikes
          the image of the man breaking it to pieces. Then the stone becomes a
          great mountain and fills the entire earth.
        </p>
      </div>

      <div className="paragraph">
        <p>
          Daniel’s prophecy about the establishment of Israel’s Kingdom of God
          has figured prominently in Mormon theology. Joseph Smith and other
          leaders have taught that the rise of the Mormon church was the
          fulfillment of Daniel’s prophecy. For nearly 170 years, up until the
          2000s, the Mormon church had set itself up, as an “ensign to all
          nations” of truth restored that will gather in the elect of the earth,
          and usher in the Second Coming and Millennium reign of Christ.
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          ...
          membership (less than four million attending Mormons) indicates a
          shrinking kingdom, not one that will fill all the earth and to which
          all nations will bow.
        </p>
      </div>

      <h2 className="headlinePadding" >Beginnings of the Mormon Kingdom</h2>
      <div className="paragraph">
        <p>
          In 1834 Joseph said, “I want to say to you before the Lord, that you
      ...
      <div className="paragraph">
        <p>
          Mormon apostle Parley Pratt published in 1838, “His [Joseph] works
          will live to endless ages, and unnumbered millions yet unborn will
          mention his name with honor … during his short and youthful career,
      ...
      <div className="paragraph">
        <p>
          Brigham stated in 1852, “The Lord God Almighty has set up a kingdom
          that will sway the scepter of power and authority over all the
          kingdoms of the world, and will never be destroyed, it is the kingdom
          that Daniel saw and wrote of. It may be considered treason to say that
          the kingdom which that Prophet foretold is actually set up; … The
      ...
      <div className="paragraph">
          <p>
          Brigham stated of the church in 1859,
          “… there is no true government on earth but the government of God, or
          the holy Priesthood … In short, it is a perfect system of government –
      ...
      <div className="paragraph">
        <p>
          Third Mormon prophet John Taylor stated in 1858, “God has set his hand
          to work to accomplish his purposes, to gather together his people, to
          establish the principles of righteousness among men, and overthrow the
        ...
        <h2 className="headlinePadding" >The Last Mormon Prophetic Statements about Daniel’s Prophecy</h2>

        <div className="paragraph">
          <p>
            In 1976, twelfth Mormon prophet Spencer Kimball spoke of Daniel’s
            prophecy. “Cyrus the great, with his Medes and Persians, would be
        ...
        <div className="paragraph">
          <p>
            Spencer Kimball then quotes Daniel, “Then shall the God of heaven set up a
            ...
            refer to this standard. “This is the kingdom of God upon the earth,
            for it is Jesus Christ who organized this kingdom.”
          </p>
        </div>

        <div className="paragraph">
          <p>
            Continuing, Spencer Kimball gave an outline of the restoration of the Mormon
            gospel. He spoke of how after “numerous revelations from the divine
            source” were given in 1830, the kingdom was “set up by the God of
            heaven, that would never be destroyed nor superseded, and the stone
            cut out of the mountain without hands that would become a great
            mountain and would fill the whole earth.”
          </p>
        </div>

        <div className="paragraph">
          <p>
            According to Spencer Kimball, the Mormon church would be the standard to
            which “the honest in heart might be looking forward.” Recalling
            Joseph Smith’s claim as restorer, Spencer Kimball added, “It came about in a
            regular, normal process. An inspired, fourteen-year-old boy … [i]n a
            dense grove of trees sought the Lord and prayed for wisdom.” The
            time had arrived “and though the adversary, Satan, recognizing all
            the powers of eternity which would be revealed with the gospel, did
            everything in his power to destroy the lad and destroy the prospects
            of the Restoration.”
          </p>
        </div>
        ...
        <div className="paragraph">
          <p>
            To establish the Mormons’ claims to divine authority to erect and
            then carry forth the “standard” Kimball continued, “In quick
            succession there came other visitors. Peter, James, and John – men
            who last held the keys of the kingdom, the power of the priesthood,
            and the blessings of eternity – appeared … and restored … power and
            authority. John the Baptist … returned to the earth and laid hands
            on the Prophet Joseph to give him the Aaronic Priesthood. The great
            Moses of antiquity returned to the earth … Elijah, the prophet …
            returned to make way and prepare for the great temple work … Moroni
            appeared … and spent long hours explaining the peopling of the
            American continents by the Lehites and also the Book of Mormon … the
            gospel was revealed, line upon line and precept upon precept, and
        ...
        <div className="paragraph">
          <p>   
            Up until the 2000s, a chorus of Mormon
            leaders claimed the Mormon church was the literal fulfillment of
            Daniel’s prophecy. Apostle Bruce McConkie published in the late
            1980s in his book Mormon Doctrine, “The Church of Jesus Christ of
            ...
            stated, “I testify that The Church of Jesus Christ of Latter-day
        ...
        <div className="paragraph">
          <p>
            In 1999, Prophet Gordon Hinckley, stated concerning the
            establishment of Mormonism, “After centuries of darkness and pain
            and struggle, the time was ripe for the restoration of the gospel
            ... The Almighty Judge of the nations, the Living God, determined
            that the times of which the prophets had spoken had arrived. Daniel
            had foreseen a stone which was cut out of the mountain without
            hands, and which became a great mountain and filled the whole earth.
        ...
        <div className="paragraph">
          <p>
            By 1844, Joseph had instilled in his followers an inspiring vision
            of the Mormon church as the nascent catalyst that would grow in
            power and might in the last days. He had his followers believing
            that they were called and ordained from the foundation of the world
            to play mighty and powerful roles of leadership as members of the
            House of Israel where they would rule over the world as Saviors on
            Mount Zion. This vision extended through the church until the 2000s.
          </p>
        </div>

        <h2 className="headlinePadding" >The Reality of Daniel as an Old Testament Figure</h2>
        <div className="paragraph">
          <p>
            But what if the biblical figure Daniel never existed? This would
            prove that this prophecy is false and a death blow to Mormonism. The
            fact of the matter is that scholars don’t believe Daniel existed.
            There is no extra-biblical evidence to support the view that Daniel
            was a real person. Scholars believe Daniel’s “prophecy” was the work
            of a later scribe from 2nd century BCE under the rule of the Greek
        ...
        <div className="paragraph">
          <p>
            If Daniel had been a real person from 6th century BCE, scholars
            question why his account contained so many errors. For example, the
            Book of Daniel gives the wrong date for Daniel’s incarceration in
            Nebuchadnezzar’s court according to historical evidence for the time
            period. He also miscalls Nebuchadnezzar “king” when at that time he
            was a prince.
          </p>
        </div>
        ...
        <div className="paragraph">
          <p>
            In chapter 4, Daniel gives an account of Nebuchadnezzar losing his
            mind for a period of time in which he lives, sleeps, and eats in the
            field with the cattle. No such episode is recorded in history. In
            Chapter 5, Daniel refers to Belshazzar as king and as being
            Nebuchadnezzar son, even though it’s known elsewhere that Belshazzar
            was never king and wasn’t related to Nebuchadnezzar. 
          </p>
        </div>
        ...
        <div className="paragraph">
          <p>
            In ChapterS
            5, Daniel says that Belshazzar is killed in a violent action when
            Darius the Mede conquers Babylon. But it was Cyrus, a Persian, who
            conquered Babylon, and he did so bloodlessly. There are also no
            historical records of the figure of Darius the Mede. For these and
            other reasons, these errors point to a 2nd century BCE author.
          </p>
        </div>

        <div className="paragraph">
          <p>
            In a time of few written records, it is hard to believe that someone
            who was allegedly an official in the administration of the very
            people he wrote about would do so. All the evidence, for what it’s
            worth, points to Daniel being a fictitious character. Therefore, if
            Daniel was not an historical person, there was no dream from God to
            interpret. There was no stone rolling down the mountain. No Kingdom
            of God for Joseph Smith to restore and build? But let’s move on from
            Daniel’s prophecy to the structure of the Mormon Kingdom in the last
            days.
          </p>
        </div>
        </div>
