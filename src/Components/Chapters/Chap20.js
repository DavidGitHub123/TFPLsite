...
import lamanitemission from '../../Assets/Img/lamanitemission.jpg'
  ...
  return (
    <div className="chapter-container">
        ...
        <div className="chapterFooter">
            <Link to="/Chap19">Previous Chapter</Link>
            <Link to="/">Home</Link>
            <Link to="/Chap21">Next Chapter</Link>
        </div>
    ...
    <div className='paragraph'>
          <p>The long-awaited day had arrived! The Book of Mormon had been published. It was time for Book of Mormon prophecy to be fulfilled. The Lamanites would have the knowledge of their identity as of the House of Israel restored. They would be taught the restored gospel and learn of God’s directive that it was their mission to build the holy city of Zion, the New Jerusalem in the last days.
          </p>
        </div>
        ...
        <div className='paragraph'>
          <p>Native Americans had been pushed to the western boundary of the United States. They were living in reservations on the border of Missouri due to the Indian Removal Act of 1830. To the Mormons this was fortuitous timing. Surely, this was God’s doing in pushing the Native Americans, a lost remnant of the House of Israel, into a concentrated location where they could hear the restored gospel. The Mormons were not alone in their desire to convert Native Americans. Other Christian missionaries had gathered in Missouri to seize the opportunity to proselytize the Native Americans, this lost remnant of the House of Israel in order to win converts.
          </p>
        </div>

        <div className='paragraph'>
          <p>The Mormon newspaper The Evening and The Morning Star reported in 1832, quoting Isaiah, “It is not only gratifying, but almost marvelous, 
            to witness the gathering of the Indians. The work has been going on for some time, and these remnants of Joseph (the Native Americans) 
            gather by hundreds to settle west of the Missouri and Arkansas. And is not this scripture fulfilling, ‘Give ear, O Shepherd of Israel, 
            thou that leadest Joseph like a flock’ and through the instrumentality of the government of the United States? For it is written, 
        ...
        <div className='paragraph'>
          <p>These four missionaries must have anticipated seeing ancient prophecies fulfilled regarding the House of Israel. They would see the results of the hand of God who caused great migrations of the Old Testament Joseph’s descendants “as a fruitful bough” crossing the ocean to become Nephites and Lamanites in the New World. With eagerness, these missionaries must have looked to the moment with reverence that their message would ring true and familiar to these Lamanites with the blood of Israel coursing through their veins. In great numbers the Native Americans would accept their message of Mormonism and began to build Zion so Christ could come again.
          </p>
        </div>

        <h2 className="headlinePadding">Book of Mormon Prophecies Go Unfulfilled</h2>
        ...
        <div className='paragraph'>
          <p>In November 1830, the missionaries reached their second group of Native Americans in the upper Sandusky River region. Parley records the Wyandots received the missionaries with kindness but doesn’t mention any baptisms. Next, the missionaries traveled to Missouri, arriving in Independence on January 13, 1831. They soon realized that missionary work by other Christian denominations was underway among the Native Americans there.
          </p>
        </div>

        <div className='paragraph'>
          <p>The missionaries first met with the Shawnee but stayed only one night. The next day, they made their way to a settlement of the Delaware Tribe. The Delaware Chief treated them kindly, giving them both rest and food. After eating, the missionaries relayed their message of the Book of Mormon by way of an interpreter. Oliver Cowdery stated, “Aged Chief and Venerable Council of the Delaware Nation; we are glad of this opportunity to address you as our red brethren and friends. We have travelled a long distance from towards the rising sun to bring you glad news … to communicate to you great knowledge … which will do the red man good as well as the pale face.”
          </p>
        </div>

        <div className='paragraph'>
          <p>Oliver told of the Book of Mormon narrative and how America was given to the Lamanites as a land of inheritance: “Once the red men were many; they occupied the country from sea to sea – from the rising to the setting sun; the whole land was theirs; the Great Spirit gave it to them, and no pale faces dwelt among them. But now they are few in numbers; their possessions are small, and the pale faces are many. 
          </p>
        </div>

        <div className='paragraph'>
          <p>“Thousands of moons ago, when the red men’s forefathers dwelt in peace and possessed this whole land, the Great Spirit talked with them, and revealed His law and His will, and much knowledge to their wise men and prophets. This they wrote in a Book; together with their history, and the things which should befall their children in the latter days. This Book [of Mormon] was written on plates of gold and handed down from father to son for many ages and generations. 
          </p>
        </div>

        <div className='paragraph'>
          <p>“It was then that the people prospered and were strong and mighty; they cultivated the earth; built buildings and cities, and abounded in all good things, as the pale faces now do. But they became wicked; they killed one another and shed much blood; they killed their prophets and wise men and sought to destroy the Book. 
          </p>
        </div>

        <div className='paragraph'>
          <p>“The Great Spirit became angry and would speak to them no more; they had no more good and wise dreams; no more visions; no more angels sent among them by the Great Spirit; and the Lord commanded Mormon and Moroni, their last wise men and prophets, to hide the Book [of Mormon] in the earth, that it might be preserved in safety, and be found and made known in the latter day to the pale faces who should possess the land.
          </p>
        </div>

        <div className='paragraph'>
          <p>“… if the red man would then receive this Book [of Mormon] and learn the things written in it, and do according thereunto, they should cease to fight and kill one another; should become one people; cultivate the earth in peace, in common with the pale faces, who were willing to believe and obey the same Book [of Mormon] and be good men and live in peace. 
          </p>
        </div>

        <div className='paragraph'>
          <p>“… The Book [of Mormon], which contained these things, was hid in the earth by Moroni, in a hill called by him, Cumorah, which hill is now in the State of New York, near the village of Palmyra, in Ontario County. In that neighborhood there lived a young man named Joseph Smith, who prayed to the Great Spirit much, in order that he might know the truth; and the Great Spirit sent an angel to him and told him where this Book [of Mormon] was hid by Moroni; and commanded him to go and get it. 
          </p>
        </div>

        <div className='paragraph'>
          <p>“He accordingly went to the place, and dug in the earth, and found the Book [of Mormon] written on gold plates. But it was written in the language of the 
        ...
        <div className='paragraph'>
          <p>But a “spirit of inquiry” is different from accepting Mormon baptism and being inspired to build the holy city of Zion, the New Jerusalem. Pratt does not indicate that any Delaware were baptized.
          </p>
        </div>

        <h2 className="headlinePadding">The End of the Lamanite Mission</h2>

        <div className='paragraph'>
          <p>Trouble was on the horizon. News of the missionaries entering Indian Territory and preaching among the Native Americans reached the local Indian agent. The Mormons had failed to acquire the necessary legal license to proselytize in Indian Territory. The agent ordered the missionaries out of Indian Territory immediately, threatening them with removal by force.
          </p>
        </div>

        <div className='paragraph'>
          <p>Given the centuries of prophecy and anticipation, one would think that God would have inspired the four missionaries to obtain a license! As Mormons always do, 
        ...
        <div className='paragraph'>
          <p>Sir, While I address your honor by this communication I do it with much pleasure understanding it pleasing your honor to countenance every exertion made by the 
            philanthropist for the instruction of the Indian in the arts of civilized life which is a sure productive of the Gospel of Christ.  As I have been appointed by a 
        ...
        <div className='paragraph'>
          <p>No correspondence exists to show that Clark replied to Oliver. But there is a letter from the Indian agent, who removed the Mormons from Indian Territory to the Superintendent of Indian Affairs.
          </p>
        </div>

        <div className='paragraph'>
          <p>“A few days ago three Men all Strangers to me went among the Indians Shawnees & Delawares, they say for the purpose of preaching to and Instructing them in 
            Religious Matters, they say they are sent by God and must proceed, they have a new Revelation with them, as their Guide in teaching the Indians, which they say 
            was shown to one of their Sects in a Miraculous way, and that an Angel from Heaven appeared to one of their Men and two others of their Sect, and shewed them 
            that the work was from God, and much more &c. I have refused to let them stay or, go among the Indians unless they first obtain permission from you or, some of 
        ...
        <div className='paragraph'>
          <p>After receiving no reply, the missionaries returned to Missouri, effectively bringing the Lamanite mission to an end. If it were God’s purpose to bring the 
