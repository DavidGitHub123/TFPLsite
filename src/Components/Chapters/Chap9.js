...
import lost10tribes from '../../Assets/Img/lost10tribes.jpg'
...
const Chap9 = () => {
  return (
    <div className="chapter-container">
      ...
      <h2 className="headlinePadding">The Ten Tribes Taken Captive</h2>
      ...
      <h2 className="headlinePadding">Where are the Lost Ten Tribes Now?</h2>
      ...
      <h2 className="headlinePadding">Joseph Teaches Ten Tribes are Not on the Earth</h2>
      ...
      <h2 className="headlinePadding">Interview of Homer Brown</h2>
      ...
      <h2 className="headlinePadding">Return from the North Country</h2>
