...
const Chap3 = () => {
  return (
    <div className="chapter-container">
      ...
      <img src={angelmoroni} className='image' alt='Angel Moroni appearing to Joseph Smith' />

    <div className="wrapper">

      <div className="paragraph">
        <p>
          Joseph’s vision of building the Kingdom of God was expansive and
          impressive. From his small band of followers in the 1830s, Joseph
      ...
      <div className="paragraph">
        <p>
          Building the Kingdom of God requires builders. It would be necessary
          to gather the elect of God, the righteous leaven of the earth, to a
          central location. Joseph revealed, “Hearken, O ye elders of my church,
          saith the Lord your God, who have assembled yourselves together … in
      ...
      <div className="paragraph">
        <p>
          Joseph’s revelations led early Mormons to believe that they were
          inheriting sacred land that they would possess forever, into the
          Millennium. The lands around Jackson County were the location of the
          Garden of Eden. According to Joseph, after Adam and Eve left the
          garden, human civilizations began to spread from this location. Just
          before the Second Coming, a great council would be held nearby at
          Adam-ondi-Ahman where Adam would bless his posterity.
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          According to the church today, its mission is to help “all of God’s
          children come to Jesus Christ through learning about His gospel,
          making and keeping promises with God (covenants), and practicing
          Christlike love and service.” But that is not the original mission of
          the church.
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          According to Mormon scripture and Joseph’s prophetic utterances, the
          purpose of the restoration was the gathering of the righteous elect
          from the four corners of the earth. To make them kings and priests,
          and queens and priestesses. To establish a physical, temporal Kingdom
          of God in the holy city, which would serve as a refuge for the
          righteous in the last days prior to Christ’s Second Coming – where the
          world and its wickedness would be consumed in the fire and light and
          Christ’s presence. Much more exciting!
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          ...
          shall be reared in this generation. For verily, this generation shall
      ...
      <div className="paragraph">
        <p>
          When “the Lord” says “a cloud shall rest upon it, which cloud shall be
          even the glory of the Lord” imagine an intense shaft of heavenly light
          full of intelligence, knowledge, and spirit illuminating the holy
      ...
      <div className="paragraph">
        <p>
          If true, it sounds wonderful to be in this theophany – none of the
          earthly woes and sorrows we experience. All nations of the earth will
          look to the holy city of Zion. Joseph revealed in 1832, “And the
      ...
      <div className="paragraph">
        <p>
          ...
          Mormons continued to believe. Mormon apostle Orson Pratt stated in
          1870, “God promised in the year 1832 that we should, before this
          generation then living had passed away, return and build up the City
          of Zion in Jackson County … He promised us that He would manifest
          Himself on that temple, that the glory of God should be upon it.”
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          In 1935, 105 years (more than three generations) Mormon apostle Joseph
          Fielding Smith stated, “I firmly believe that there will be some of
          that generation who were living when this revelation was given (1832)
          who shall be living when this temple is reared. And I do not believe
      ...
      <div className="paragraph">
        <p>
          Still at it, then-prophet Joseph Fielding Smith stated in 1972 – 140
          years after the 1832 revelation (more than five generations), “It may
          be reasonable to assume that in giving this revelation to the prophet
          the Lord did have in mind the generation of people who would still be
          living within the one hundred years from the time of announcement of
      ...
      <div className="paragraph">
        <p>
          The truth of the matter is that six years after the 1832 revelation,
          the Mormons were driven from Missouri in 1838. Large numbers of
          Mormons had poured into the state, announcing that the land settled
          and owned by the Missourians had been given to the Mormons by God for
          their everlasting inheritances. This naturally infuriated the
          Missourians. The threat of being displaced from their homes and farms
          created tensions. Missourians began violently pushing back against the
          Mormons. Omitted from church history lessons today, the Mormons pushed
          back violently as well – even criminally.
        </p>
      </div>

      <div className="paragraph">
        <p>
          Claiming the need to retaliate against the malevolent Missourians, the
          Mormons formed the Danites. This oath-bound group went about stealing
          and storing their plunder in bishop storehouses. Just as the
          Missourians were doing, the Mormon Danites destroyed Missourians’
          property, killing livestock, and burning barns.
        </p>
      </div>

      <div className="paragraph">
        <p>
          Hostilities increased to the point that the conflict was named the
      ...
      <div className="paragraph">
        <p>
          Between 1832 and 1838, both Mormons and Missourians were killed and
          beaten – all in an attempt to obey their prophet and establish Zion,
          God’s holy city. Eventually, Joseph and church leaders were imprisoned
          in Liberty Jail for war crimes. The Mormons had lost practically
          everything. In the dead of winter, Joseph’s followers fled for Nauvoo
          – their immediate hopes of building the holy city of Zion dashed.
        </p>
      </div>

      <div className="paragraph">
        <p>
          However, there was a silver lining for Joseph. The events of Missouri,
          and the maltreatment the Mormons endured, galvanized Joseph’s
          followers. The persecution they suffered carved a deep conviction that
          Mormonism was the true gospel into their souls. For decades and
          decades, Mormons would replay a one-sided persecution narrative over
          pulpits and talk of the Lord leading the Mormons back to their
          promised land one day.
        </p>
      </div>
      ...
      <div className="paragraph">
        <p>
          Just as a treasure diviner blames the men digging for not following
          instructions, Joseph blamed the Mormons for their unrighteousness.
          “Behold … were it not for the transgressions of my people, speaking
          concerning the church and not individuals, they might have been
          redeemed even now. But behold, they have not learned to be obedient to
      ...
      <div className="paragraph">
        <p>
          Later, we will review the dark history of the failed attempt to build
          Zion in greater detail.
        </p>
      </div>
