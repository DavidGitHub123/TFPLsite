...
import nauvootemple from '../../Assets/Img/nauvootemple.jpg'
  ...
  return (
    <div className="chapter-container">
      ...
      <div className="chapterFooter">
        <Link to="/Chap30">Previous Chapter</Link>
        <Link to="/">Home</Link>
        <Link to="/Chap32">Next Chapter</Link>
      </div>
    ...
    <div className='paragraph'>
          <p>At the dawning of the 20th century, Mormonism was in crisis. Joseph’s prophetic vision of the latter days had not come to pass. The first generation of Mormons never built holy city in Jackson County. There was no return to Jackson County from Utah, as the Mormons were led to believe. There was no Second Coming by 1891. There was no great Millennial day of light and peace with Christ ruling the world. Given the weight of the evidence staring Mormonism in the face at the turn of the 20th century, why is Mormonism alive today? Why would men of truth and integrity, claiming to be apostles holding priesthood keys of God’s authority, continue to perpetuate Joseph’s failed restoration? 
          </p>
        </div>

        <div className='paragraph'>
          <p>Psychologically, we lean into our biases. Church leaders and members couldn’t bring themselves to abandon their religion! Mormonism had become their identity and worldview. It was woven into the fabric of their souls. Since childhood, their belief system had been shaped culturally and socially in the Mormon way. They had been shaped through social and religious conditioning. It was their family and social support system. It was their “hero system,” an ideological framework, providing a clear life path to follow.
          </p>
        </div>

        <div className='paragraph'>
          <p>Church leaders and members had been shaped by years of indoctrination, buttressed by emotional rewards from church leaders and family. When confronted by contrary facts, almost without a conscious thought, they told themselves that Joseph’s restoration was true anyway. They rationalized and justified, “The Lord will make it all right in the end.” They somehow cordon off the damning evidence to prevent it from influencing their belief system. They just wouldn’t let their minds go there. No one or nothing could break them down. 
          </p>
        </div>

        <h2  className="headlinePadding"> Mormonism 2.0</h2>

        <div className='paragraph'>
          <p>What was the church’s response to these prophetic failures and troubled history? Create Mormonism 2.0 for the 20th century. (Today, we are witnessing the creation of Mormonism 3.0 for the 21st century, as the church continues to struggle amidst declining membership.)
          </p>
        </div>

        <div className='paragraph'>
          <p>Since its founding, the violence, strangeness, and fanaticism of Mormonism had been an attraction with the press and book publishers. The church had to change its public perception as a secretive, radical polygamous cult. The bloody and brutal memory of the Mountain Meadows massacre, where a group of Mormons shot, bludgeoned, and macheted more than 150 men, women, and children, lingered in the public consciousness. The doctrine of blood atonement – that only death by spilling one’s blood for the most egregious sins would salvation come – had left a stain on the church’s reputation. Polygamy and the bizarre doctrines about becoming a God with Goddess wives, ruling through the eternities, needed to be dealt with.
          </p>
        </div>

        <div className='paragraph'>
          <p>Given these and many other challenges, church leaders decided it was time to reinvent Mormonism. For survival, the church created a new, sanitized version of the religion modeled after the Christian churches of the day. They began to toss off the public image of long-bearded polygamous fanatics who preached against the U.S. government. They eliminated the violent rhetoric of how the world was bound for destruction for rejecting Joseph Smith’s Mormon gospel. 
          </p>
        </div>

        <div className='paragraph'>
          <p>The strategy? Create a kinder, gentler Mormonism in its place. Drop the chief cornerstones of Joseph’s radical theology. Disregard the revealed word of the Lord and past prophetic statements. Jettison the extremist elements of one Mormon Kingdom of God to rule over all other political and religious institutions as part of Daniel’s prophecy. Deny that these things were taught by prophets, seers, and revelators. Hold on to a few remnants of Joseph’s religion – temple marriage and eternal families, priesthood authority to claim we are the one true church, prophets receive inspiration to direct the affairs of the church, etc. But never go into details on any doctrine. 
          </p>
        </div>

        <div className='paragraph'>
          <p>Keep it simple: milk before meat. Don’t disclose anything controversial to new members, such as they will be required to covenant to 
            consecrate “everything with which the Lord has blessed you … to the Church of Jesus Christ of Latter-day Saints, for the building up of 
            the Kingdom of God on the earth and for the establishment of Zion.” Bury the fact of how Mormons once believed that they were on the path 
        ...
        <div className='paragraph'>
          <p>Instead, they retained only the most basic message points: obedience to church authority, atonement, repentance, premortality, priesthood, 
            ...
            Redefine long-held beliefs. And that is what Mormon church leaders did. Does it betray Joseph’s vision for Mormonism that he claimed was the 
            revealed will of God? Yes. But they needed to keep Mormonism alive and it was their only option.
          </p>
        </div>

        <h2 className="headlinePadding" >Actions Taken</h2>

        <div className='paragraph'>
          <p>After the 1890 Manifesto, the Mormons did shave their long beards and told the U.S. government they had stopped marrying polygamous wives (even though the practice continued under the apostles). The Mormons became pro-America, wrapping themselves in the American flag and preaching patriotism – despite years of rhetoric of God destroying the wicked United States. They even eliminated the temple oath to avenge the deaths of Joseph and Hyrum.
          </p>
        </div>
        ...
        <div className='paragraph'>
          <p>The church published books on Mormons’ Christian beliefs. Third Mormon prophet John Taylor published Mediations and Atonement, a book about Christian 
            theology – mingled with simplified Mormon ideas. The premise of the book was that mankind lives in a fallen condition due to Adam’s “fortunate” fall, but 
        ...
        <div className='paragraph'>
          <p>For you and their spirit children to advance in light and truth, an earth needed to be created whereupon you and your 
            ...
            God the Father for this earth, and the biological father of Christ, Christ was the son of Michael in the premortal world? 
          </p>
        </div>

        <div className='paragraph'>
          <p>Brigham taught about the process of creating a world for your spirit children. In that process you select a spirit son to 
            be a savior and redeemer for that world. Brigham stated, “You call your spiritual children together and hold a council with 
            them; and in the contemplation of a new earth, a Saviour must be provided. You call for volunteers, there may be a number of 
            ‘bright sons’ [who] reply. It is your right to choose the one dearest to your own heart, he being worthy of the position … 
            The chosen one is ordained to his calling, a calling in the Priesthood, and placed in full charge of the organization of 
        ...
        <div className='paragraph'>
          <p>As a God (Michael/Adam) you select one on your sons (Jesus), not your celestial father (Jehovah), to be the savior on the 
            world you’re creating. As Joseph claimed God (Michael/Adam) told him, “Behold this is my beloved son in whom I am well 
            pleased.” Brigham also stated, “Adam (Michael) was as conversant with his Father (Jehovah) who placed him upon this earth 
        ...
        <h2 className="headlinePadding" >Joseph Smith Taught the Adam-God Doctrine to Early Church Leaders</h2>
        ...
        <div className='paragraph'>
          <p>Mormon prophet Wilford Woodruff was an eyewitness to many of the events of the early restoration. Joining the church 
            ...
            secrecy for his controversial teachings. Later in Utah, these teachings “never taught publicly” were made public such as polygamy, Adam-God, blood-atonement, and of course the establishment of the Mormon theocracy and the Kingdom of God.
          </p>
        </div>

        <div className='paragraph'>
          <p>First Presidency Counselor Heber Kimball stated of these additional doctrines being made public, “Dr. Bernhisel has just 
        ...
        <div className='paragraph'>
          <p>As the church went mainstream Christian in the early 20th century, it distanced itself from many of the teachings of early leaders. Their strategy was if Joseph never directly mentioned a troublesome teaching by a particular name, church leaders and apologists would claim that it was an invention of Brigham or other early apostles. The Adam-God Doctrine is laid at Brigham’s feet as his own invention. But, according to Brigham, Joseph taught church leaders at Luke Johnson’s home the Adam-God doctrine. 
          </p>
        </div>
        ...
        <div className='paragraph'>
          <p>During the 19th century and early 20th century, the Adam-God doctrine was a key part of the temple ceremony. Here is the 
            lecture given at the veil, “In the creation, the Gods entered into an agreement about forming this earth and putting Michael, 
            or Adam, upon it. These things of which I have been speaking are what are termed the mysteries of godliness … We have heard a 
            great deal about Adam and Eve … Adam was an immortal being when he came on this earth. He had lived on an earth similar to ours; 
            he had received the priesthood and the keys thereof, and had been faithful in all things, and gained his resurrection and his 
            exaltation, and was crowned with glory, immortality, and eternal lives, and was numbered with the Gods … and had begotten all 
        ...
        <div className='paragraph'>
          <p>The lecture states that Adam “had begotten all the spirit[s] that was to come to this earth, and Eve our common Mother 
            who is the mother of all living bore those spirits in the celestial world ... [They] consequently came to this earth and 
            commenced the great work of forming tabernacles for those spirits to dwell in.” This the includes Jesus Christ. Historian 
            David Buerger stated, “Although official temple scripts do not exist prior to 1877, several unfriendly published accounts 
        ...
        <h2 className="headlinePadding" >Deep-Six the Adam-God doctrine</h2>

        <div className='paragraph'>
          <p>To discard the Adam-God doctrine, in 1905 the Adam-God lecture at the veil was removed from the endowment ceremony. Also, the 
            identity of Jehovah was changed. He was declared to be a spirit version of Jesus Christ. He was made superior to Michael/Adam. 
            ...
            revelators, but desperate times call for desperate measures.
          </p>
        </div>

        <div className='paragraph'>
          <p>Because it had been replaced with a more Christ-centered, salvation narrative, the Adam-God doctrine began to fade away into the mists of history. But in the 1970s the Adam-God doctrine reared its ugly head as fundamentalist Mormons – people belonging to polygamist Mormon groups – began to discuss it publicly. Since mainstream Mormons had never heard of the doctrine, church leaders were forced to address the issue.
          </p>
        </div>
        ...
        <h2 className="headlinePadding" >Confronted with Historical Facts</h2>

        <div className='paragraph'>
          <p>During the reinvention of Mormonism in the early 20th century, probably the most damning event for a church that 
            claims to be led by a prophet who receives revelation from God, came when sixth Mormon prophet Joseph F. Smith under 
        ...
        <div className='paragraph'>
          <p>In 1902, Reed Smoot was elected to represent Utah in the U.S. Senate. Lawmakers opposed seating him given his polygamous leanings, although not a polygamist himself. It was well known in Washington, D.C., that Mormon church leaders had engaged in deception for decades. Mormon prophet Joseph F. Smith was the first witness called. His testimony was damaging to the church. Under oath, this Mormon prophet lied, claiming he had not heard anyone “advocate, encourage or recommend” plural marriages since the 1890 Manifesto. He also admitted to fathering children by five wives since 1890. 
          </p>
        </div>
        
        <div className='paragraph'>
          <p>Joseph F. Smith also admitted, as a prophet, seer and revelator, that he did not receive revelation, only impressions. Here’s the senate testimony: Senator Dubois: Have you received any individual revelations yourself, since you became president of the church under your own definition, even, of a revelation?
          </p>
        </div>

        <div className='paragraph'>
          <p>Mr. Smith: I cannot say that I have.
          </p>
        </div>

        <div className='paragraph'>
          <p>Senator Dubois: Can you say that you have not?
          </p>
        </div>
        
        <div className='paragraph'>
          <p>Mr. Smith: No; I cannot say that I have not.
          </p>
        </div>

        <div className='paragraph'>
          <p>Senator Dubois: Then you do not know whether you have received any such revelation as you have described, or whether you have not?
          </p>
        </div>
        
        <div className='paragraph'>
          <p>Mr. Smith: Well, I can say this: That if I live as I should in the line of my duties, I am susceptible, I think, of the 
        ...
        <div className='paragraph'>
          <p>What did Mormon leaders do with this alarming information? Did they reevaluate their belief systems? Did they inform church members? They swept it under the rug. They filed away Roberts’ report and sent him away on a mission. After the Secret Meetings of 1922, church leaders recorded their feelings on the veracity of the Book of Mormon, the keystone of their religion.
          </p>
        </div>

        <div className='paragraph'>
          <p>Apostle James Talmage recorded in his journal, “Jan. 4, Wed: Attended forenoon and afternoon sessions of a meeting of the First 
            Presidency, the Twelve, and the First Council of Seventies, listening to a lengthy but valuable report by Elder B. H. Roberts, 
        ...
        <div className='paragraph'>
          <p>In a letter to apostle Richard Lyman, B.H. Roberts reminded Lyman that at the conclusion of the 1922 meetings that Roberts 
        ...
        <div className='paragraph'>
          <p>Roberts later remarked on church leaders’ reactions. “… they merely one by one stood up and bore testimony to the truthfulness 
        ...
        <div className='paragraph'>
          <p>Sixteen years earlier, Mormon prophet George Albert Smith reported in 1906 that “We visited the Hill Cumorah … we felt that we 
            were standing on holy ground. The brethren located, as near as they thought was possible, the place from which the plates of 
            the Book of Mormon were taken by the Prophet … Looking over the surrounding country we remembered that two great races of 
            people had wound up their existence in the vicinity, had fought their last fight, and that hundreds of thousands had been 
        ...
        <div className='paragraph'>
          <p>I’ve visited the Hill Cumorah twice – once as a believer, and once as a non-believer. My first visit was similar to 
            George Albert Smith’s visit, but on my second visit I knew the truth about the truth claims of Mormonism. I couldn’t 
            pretend. My first visit was based on emotional attachment to Mormonism. My second visit was based on knowing the reality 
            of Mormonism. On my second visit, I was visiting a nice grove surrounded by a visitor center, replica of Joseph’s 
        ...
        <h2 className="headlinePadding" >More Bad News from Scholars and Historians</h2>

        <div className='paragraph'>
          <p>As the years unfolded, more evidence mounted against Mormon scripture and restoration claims. Fawn Brodie’s 1945 No Man Knows My History was one of the first significant and honest histories of Joseph Smith – running counter to the whitewashed history produced by the church. This was the first of many honest books and articles to follow over the decades telling the true history of Joseph and the rise of Mormonism.
          </p>
        </div>
        
        <div className='paragraph'>
          <p>For the first time in the 20th century, No Man Knows My History presented many of the historical issues that the church struggles against today. She presents Joseph as a good-natured, but unsuccessful treasure seeker. She claims Joseph invented the idea of gold plates hidden in the nearby Hill Cumorah and then developed that into the idea of a religious novel. She posited that much of the Book of Mormon comes from Ethan Smith’s early writing of View of the Hebrews, published in 1823, which has a narrative similar to the Book of Mormon. Her book portrays Joseph as a deliberate impostor, building a church to gratify his ambitions. She details Joseph’s financial scandals, legal scrapes, prophetic failures, and sexual desires through the institution of polygamy.
          </p>
        </div>

        <div className='paragraph'>
          <p>More damning evidence came when the Joseph Smith Papyri was discovered in 1966 – the Egyptian materials Joseph used to 
            construct the Book of Abraham. In the late1960s, Egyptologists translated these materials. They discovered the papyri Joseph 
        ...
        <div className='paragraph'>
          <p>Also in the 1960s, disaffected Mormons Jerald and Sandra Tanner, founded Utah Lighthouse Ministry, a clearinghouse for historical materials about Mormonism. They made original versions of early Mormon writings and revelations available to the public for the first time, highlighting doctrinal changes over time and problematic statements from church leaders. In 1966, they published Joseph Smith’s Egyptian Alphabet and Grammar, a translation document Joseph created to help him translate the Book of Abraham. Its contents have been problematic for the credibility of the Book of Abraham.
          </p>
        </div>

        <div className='paragraph'>
          <p>The Tanners have also republished early Mormon newspapers including Messenger and Advocate, Times and Seasons, and the Millennial Star. These newspapers, dating back to the founding of the church, contain challenging statements of doctrine and provide sources for the unflattering historical events. The Tanners have additionally published lists of changes to the text of the Book of Mormon and other texts used by the Mormon church. The Tanners argued that the alterations were substantial and that the inconsistencies in the texts are evidence against Mormon claims of their being divinely inspired. If these things came from God, why change them?
          </p>
        </div>
        
        <div className='paragraph'>
          <p>In 1966, the journal Dialogue was founded, and Sunstone magazine began publication in 1974. Both journals discussed Mormonism through the lens of historical research and scholarship. The church signaled to members to not participate by releasing this statement, “… We are especially saddened at the participation of our own members, especially those who hold Church or other positions that give them stature among Latter-day Saints and who have allowed their stature to be used to promote such presentations … Some of the presentations by persons whom we believe to be faithful members of the Church have included matters that were seized upon and publicized in such a way as to injure the Church or its members or to jeopardize the effectiveness or safety of our missionaries.”
          </p>
        </div>
        ...
        <div className='paragraph'>
          <p>According to Boyd Packer, “Those of you who are employed by the Church have a special responsibility to build faith, not destroy it . . . Those who have carefully purged their work of any religious faith in the name of academic freedom or so-called honesty ought not expect to be accommodated in their research, or to be paid by the Church to do it.” Boyd Packer went on to warn seminary and institute instructors not to include in their lessons material which might endanger faith. “Nor should they portray church leaders as merely human beings but should stress their spiritual strengths as prophets of God.”
          </p>
        </div>

        <div className='paragraph'>
          <p>Boyd Packer issued eternal threats. “That historian or scholar who delights in pointing out the weakness and frailties of present or past leaders destroys faith. A destroyer of faith … places himself in great spiritual jeopardy. He is serving the wrong master, and unless he repents, he will not be among the faithful in the eternities.” He continued with the threats. “… regardless of how they may injure the Church or destroy the faith of those not ready for ‘advanced history’ is himself in spiritual jeopardy … he has broken his covenants and will be accountable. After all of the tomorrows of mortality have been finished, he will not stand where he might have stood.” Boyd Packer’s talk sent a clear message to the church: certain topics were not to be discussed, meaning an honest history was officially off the table.
          </p>
        </div>
        
        <div className='paragraph'>
          <p>Another major hit to the credibility of the church and its leaders was the Mark Hofman debacle in the mid-1980s, which left two people dead. Hoffman created forgeries, claiming them to be authentic early church documents. These included the White Salamander Letter. Hoffman’s forgeries provided evidence of Joseph Smith’s treasure-digging, as well as the use of the occult and folk magic to create Mormonism – showing a history counter to the whitewashed narrative of church history. Hofmann’s murders drew national attention to the church. Besides shining a light on controversial elements of church history regarding its founding, the matter was an embarrassment that men claiming to be prophets, seers, and revelators, with a direct line to God, could be duped by a forger.
          </p>
        </div>

        <div className='paragraph'>
          <p>In 1987, Michael Quinn’s Mormonism and the Magic World View demonstrated the influence of folk magic, seer stones, divining rods, talismans, and astrology in the formation of the Mormon religion. Quinn demonstrated how Joseph, his family, and the early leaders and converts to Mormonism were involved in folk magic participating in superstitious practices to dig for hidden treasure, conjure spirits, and using magic artifacts. Many of these elements found their way into the early doctrines of the church. But later these elements were removed from the history of Mormonism, and changes made to the scriptures, to form a more Christian narrative.
          </p>
        </div>

        <div className='paragraph'>
          <p>Despite all these materials being available, they were difficult to access. You needed to buy books, visit libraries, etc. But then, in the 1990s, the Internet came along. Suddenly, the truth was only a click away – and all hell broke loose on the Mormon church.
          </p>
        </div>
