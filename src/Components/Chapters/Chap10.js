...
import jerusalem from '../../Assets/Img/jerusalem.png'
  ...
  return (
    <div className="chapter-container">
      ...
      <div className="chapterFooter">
          <Link to="/Chap9">Previous Chapter</Link>
          <Link to="/">Home</Link>
          <Link to="/Chap11">Next Chapter</Link>
      </div>
    ...
    <div className='paragraph'>
          <p>In 1831, Joseph revealed that the events of the last days would come to pass in the generation of 
            ...
            Jews by the 1860s. Then Christ would appear shortly thereafter.
          </p>
        </div>
        ...
        <div className='paragraph'>
          <p>Joseph also told early Mormons that they would assist the Jews in their prophesied return to Palestine and establishing a 
            second Zion in Jerusalem. First Presidency Counselor Heber Kimball stated that Joseph said, “The day will be when I will 
        ...
        <div className='paragraph'>
          <p>First Presidency Counselor Charles Penrose explained that Christ would establish Zion in Jerusalem, the Kingdom of God 
            ...
            Jerusalem then becomes the seat of empire, and the great centre and capital of the old world.” Parley continued, 
            “... In short, the kings, rulers, priests and people … shall know this once that there is a God in Israel, who, 
        ...
        <h2 className="headlinePadding">Dedicating the Holy Land </h2>
        ...
        <div className='paragraph'>
          <p>In April 1840, Joseph sent Orson Hyde to dedicate Jerusalem for the return of the Jews, and to encourage the leaders 
            ...
            by the 1860s, and no second Zion was ever established in Jerusalem.
          </p>
        </div>

        <h2 className="headlinePadding">Three Visits of Christ</h2>

        <div className='paragraph'>
          <p>First Presidency Counselor Charles Penrose explained that Christ will appear (before his Second Coming) to the Jews at Jerusalem to set up his kingdom – the second Zion. Charles describes three visits that Christ would make to the earth. The first is to Zion in Jackson County. The second is to the Jews in Jerusalem. The third is Christ’s Second Coming in glory.
          </p>
        </div>

        <div className='paragraph'>
          <p>Discussing his first appearance to Zion in Jackson County, Charles states, “Among the first-mentioned of these three classes of men the Lord will make his appearance first; and that appearance will be unknown to the rest of mankind. He will come to the Temple prepared for him, and his faithful people will behold his face, hear his voice, and gaze upon his glory. From his own lips they will receive further instructions for the development and beautifying of Zion and for the extension and sure stability of his kingdom.”
          </p>
        </div>

        <div className='paragraph'>
          <p>Then Christ will appear to the Jews at Jerusalem. “His next appearance will be among the distressed and nearly vanquished sons of Judah. At the crisis of their fate, when the hostile troops of several nations are ravaging the city and all the horrors of war are overwhelming the people of Jerusalem, he will set his feet upon the Mount of Olives, which will cleave and part asunder at his touch.” 
          </p>
        </div>

        <div className='paragraph'>
          <p>Charles continued, “Attended by a host from heaven, he will overthrow and destroy the combined armies of the Gentiles and appear to the worshipping Jews as the mighty Deliverer and Conqueror so long expected by their race; and while love, gratitude, awe, and admiration swell their bosoms, the Deliverer will show them the tokens of his crucifixion and disclose himself as Jesus of Nazareth, whom they had reviled and whom their fathers put to death. Then will unbelief part from their souls, and ‘the blindness in part which has happened unto Israel’ be removed. ‘A fountain for sin and uncleanness shall be opened to the house of David and the inhabitants of Jerusalem,’ and ‘a nation will be born’ unto God ‘in a day.’ They will be baptized for the remission of their sins, and will receive the gift of the Holy Ghost, and the government of God as established in Zion will be set up among them, no more to be thrown down forever.”
          </p>
        </div>

        <div className='paragraph'>
          <p>Then, Charles provides a brief glimpse of the Second Coming. “The great and crowning advent of the Lord will be subsequent 
        ...
        <h2 className="headlinePadding">The Jews to Receive the Restored Gospel at Jerusalem</h2>
        ...
        <div className='paragraph'>
          <p>But not all Jews will accept the restored gospel. We know this because the Bible explains that there will be unbelieving 
        ...
        <h2 className="headlinePadding">King David’s Ancient Throne</h2>

        <div className='paragraph'>
          <p>To fulfil biblical prophecy, a government must be established at Jerusalem. According to Joseph Smith, the political system to be established in the second Zion at Jerusalem will be a restoration of King David’s ancient throne and kingdom. Joseph taught that a descendant of King David, whose name will also be David, will direct the operations of the government of God on earth, under Christ. 
          </p>
        </div>
